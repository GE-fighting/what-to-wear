...
// Create 创建穿着记录
func (r *wearRecordRepository) Create(record *models.WearRecord) error {
	return r.db.Create(record).Error
}

// GetByID 根据ID获取穿着记录
func (r *wearRecordRepository) GetByID(id uint) (*models.WearRecord, error) {
...
func (r *wearRecordRepository) GetByClothingItemID(clothingItemID uint, limit int) ([]models.WearRecord, error) {
	var records []models.WearRecord
	query := r.db.Where("clothing_item_id = ?", clothingItemID).
...
// Update 更新穿着记录
func (r *wearRecordRepository) Update(record *models.WearRecord) error {
	return r.db.Save(record).Error
}

// Delete 删除穿着记录
func (r *wearRecordRepository) Delete(id uint) error {
	return r.db.Delete(&models.WearRecord{}, id).Error
}

// GetByUserID 根据用户ID获取穿着记录
func (r *wearRecordRepository) GetByUserID(userID uint, limit int) ([]models.WearRecord, error) {
	var records []models.WearRecord
	query := r.db.Joins("JOIN clothing_items ON wear_records.clothing_item_id = clothing_items.id").
...
func (r *wearRecordRepository) GetByDateRange(userID uint, startDate, endDate string) ([]models.WearRecord, error) {
	var records []models.WearRecord
	err := r.db.Joins("JOIN clothing_items ON wear_records.clothing_item_id = clothing_items.id").
...
func (r *wearRecordRepository) GetByOccasion(userID uint, occasion string) ([]models.WearRecord, error) {
	var records []models.WearRecord
	err := r.db.Joins("JOIN clothing_items ON wear_records.clothing_item_id = clothing_items.id").
...
func (r *wearRecordRepository) GetByWeather(userID uint, weather string) ([]models.WearRecord, error) {
	var records []models.WearRecord
	err := r.db.Joins("JOIN clothing_items ON wear_records.clothing_item_id = clothing_items.id").
...
func (r *wearRecordRepository) GetWearStats(clothingItemID uint) (map[string]interface{}, error) {
	...
	err := r.db.Model(&models.WearRecord{}).
...
func (r *wearRecordRepository) GetWearFrequency(userID uint) (map[string]int64, error) {
	var results []struct {
...
func (r *wearRecordRepository) GetComfortRatings(userID uint) (map[uint]float64, error) {
	var results []struct {
...
func (r *wearRecordRepository) GetWeatherStats(userID uint) (map[string]int64, error) {
	var results []struct {
...
func (r *wearRecordRepository) GetActivityStats(userID uint) (map[string]int64, error) {
	var results []struct {
...
// GetMoodStats 获取心情统计
func (r *wearRecordRepository) GetMoodStats(userID uint) (map[string]int64, error) {
	var results []struct {
...
func (r *wearRecordRepository) GetWearIntensityStats(userID uint) (map[string]int64, error) {
	var results []struct {
...
func (r *wearRecordRepository) GetRecentWearRecords(userID uint, limit int) ([]models.WearRecord, error) {
	var records []models.WearRecord
	query := r.db.Joins("JOIN clothing_items ON wear_records.clothing_item_id = clothing_items.id").
		Where("clothing_items.user_id = ?", userID).
...
func (r *wearRecordRepository) GetHighRatedWears(userID uint, minRating int, limit int) ([]models.WearRecord, error) {
	var records []models.WearRecord
	query := r.db.Joins("JOIN clothing_items ON wear_records.clothing_item_id = clothing_items.id").
...
func (r *wearRecordRepository) GetWearsByTemperatureRange(userID uint, minTemp, maxTemp float64) ([]models.WearRecord, error) {
	var records []models.WearRecord
	err := r.db.Joins("JOIN clothing_items ON wear_records.clothing_item_id = clothing_items.id").
...
func (r *wearRecordRepository) GetTotalWearTime(userID uint) (int64, error) {
...
func (r *wearRecordRepository) GetWearRecordsByMonth(userID uint, year int) (map[string]int64, error) {
	var results []struct {
